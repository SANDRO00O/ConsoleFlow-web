...
const faqs = [
  {
    ...
    answer: 'It is a lightweight Android browser built for debugging and quick checks on mobile.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes. You can add custom JavaScript that runs on page load for your own testing workflow.',
  },
];
        ...
        <div className="mb-10 pt-6">
          ...
          <div className="mt-8 grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
            <div className="space-y-4">
              <span className="mx-auto inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-4 py-2 text-[11px] font-medium uppercase tracking-[0.24em] text-gray-400">
                <HelpCircle className="h-3.5 w-3.5 text-cyan-300" />
                Questions
              </span>
              <h1 className="mx-auto max-w-sm text-4xl font-semibold tracking-tight text-white sm:text-5xl">
                Frequently asked questions
              </h1>
              <p className="mx-auto max-w-md text-base leading-7 text-gray-400">
            ...
            <div className="space-y-4">
              {faqs.map((faq, index) => (
                <motion.article
                  ...
                  className="rounded-[28px] border border-white/8 bg-white/[0.03] p-6 text-center shadow-[0_20px_60px_rgba(0,0,0,0.16)]"
                >
                  <h2 className="text-lg font-semibold tracking-tight text-white">{faq.question}</h2>
                  <p className="mx-auto mt-3 max-w-2xl text-sm leading-7 text-gray-400">{faq.answer}</p>
                </motion.article>
              ))}
            </div>
          </div>
